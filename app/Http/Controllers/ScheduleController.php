...
class ScheduleController extends Controller
{
   	...
   	public function view(){
         ...
         DB::table('tbl_hearing')->whereDate('hearing_sched','<',date('Y-m-d'))->whereIn('hearing_status',array('For Process', 'Pending'))->update(['hearing_status'=>'For Reschedule']);

         DB::table('tbl_hearing')->whereDate('hearing_sched','=',date('Y-m-d'))->whereTime('hearing_sched','<=',date('H:i:s'))->update(['hearing_status'=>'For Process']);
